...
namespace cszmcaux
{
    ...
    public class zmcaux
    {
        ...
        public static extern Int32 ZAux_GetModbusIn(IntPtr handle, int ionumfirst, int ionumend,out byte[] pValueList);
        ...
        public static extern Int32 ZAux_GetModbusOut(IntPtr handle, int ionumfirst, int ionumend, out byte[] pValueList);
        ...
        /// <param name="piAxislist">轴列表</param>
        /// <param name="pfDisancelistNumber">螺旋轴距离有效的数量  如数量为2表示第0个和第2个轴需要有效的结束位置，但第三个轴不参与</param>
        ...
        public static extern Int32 ZAux_Direct_McircTurnabs(IntPtr handle, int tablenum, float refpos1, float refpos2, int mode, float end1, float end2, int imaxaxises, int[] piAxislist, UInt32 pfDisancelistNumber, float[] pfDisancelist);
        ...
        /// <param name="tableNumber">控制卡接收返回Table寄存器编号</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_BusCmd_SDORead", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_BusCmd_SDORead(IntPtr handle, UInt32 slot, UInt32 node, UInt32 index, UInt32 subindex, UInt32 type, ref Int32 value,UInt32 tableNumber=0);
        ...
        public static extern Int32 ZAux_BusCmd_SDOReadAxis(IntPtr handle, UInt32 iaxis, UInt32 index, UInt32 subindex, UInt32 type, ref Int32 value,UInt32 tableNumber=0);
        ...
        public static extern Int32 ZAux_Direct_GetInMulti(IntPtr handle, int startio, int endio,out Int32 piValue);
        ...
        *************************************************************/
        ...
        /// <param name="handle">连接句柄</param>
        /// <param name="Axisnum">轴号</param>
        /// <param name="Mode">模式  查看函数定义上方注释或者是编程手册</param>
        /// <param name="Opnum">输出口编号</param>
        ...
        /// <param name="ModePara5">功能参数5</param>
        /// <param name="ModePara6">功能参数6</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_HwPswitch2", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_HwPswitch2(IntPtr handle, int Axisnum, int Mode, int Opnum, int Opstate, float ModePara1, float ModePara2, float ModePara3, float ModePara4, float ModePara5, float ModePara6);
        ...
        public static extern Int32 ZAux_Direct_GetOutMulti(IntPtr handle, UInt16 iofirst, UInt16 ioend,out UInt32 istate);
        ...
        /// <returns></returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_SetVpMode", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_SetVpMode(IntPtr handle, UInt32 axis, UInt32 mode);
        ...
        /// <param name="mode">模式:bit0：1-VP_SPEED缺省使用插补速度，0-VP_SPEED 使用单轴的速度  bit1：1 - 使用MOVE_OP精确输出功能， 0 - MOVE_OP原来的方式   bit4：1 - 对带编码器功能的轴，使用编码器位置的MOVE_OP精准方式   多个编码器轴插补时，使用BASE运动主轴的设置</param>
        /// <returns></returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_SetAxisZset", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_SetAxisZset(IntPtr handle, UInt32 axis, UInt32 mode);
        ...
        /// <returns></returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_BusCmd_SlotScan", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_BusCmd_SlotScan(IntPtr handle, UInt32 slotNumber);
        ...
        /// <param name="slotNumber">槽位号</param>
        /// <returns></returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_BusCmd_SlotStart", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_BusCmd_SlotStart(IntPtr handle, UInt32 slotNumber);
        ...
        /// <param name="slotNumber">槽位号</param>
        /// <returns></returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_BusCmd_SlotStop", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_BusCmd_SlotStop(IntPtr handle, UInt32 slotNumber);
        ...
        /// <returns></returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_GetSysZfeature", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_GetSysZfeature(IntPtr handle, UInt32 code,ref UInt32 value);
        ...
        /// <returns></returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_SetServoPeriod", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_SetServoPeriod(IntPtr handle, UInt32 value);
        /// <summary>
        /// 总线通讯周期获取
        /// </summary>
        /// <param name="handle">句柄</param>
        /// <param name="value">值</param>
        /// <returns></returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_GetServoPeriod", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_GetServoPeriod(IntPtr handle,ref UInt32 value);
        ...
        /// <returns></returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_BusCmd_GetNodeAxisCount", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_BusCmd_GetNodeAxisCount(IntPtr handle, UInt32 slot, UInt32 node,ref UInt32 axisNumber);
        ...
        /// <returns></returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_BusCmd_SetDriveProfile", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_BusCmd_SetDriveProfile(IntPtr handle, UInt32 axis, int mode);
        ...
        /// <returns></returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_BusCmd_GetDriveProfile", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_BusCmd_GetDriveProfile(IntPtr handle, UInt32 axis,ref int mode);
        ...
        /// <returns></returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_BusCmd_SetDriveIO", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_BusCmd_SetDriveIO(IntPtr handle, UInt32 axis, UInt32 IoStart);
        ...
        /// <param name="IoStart">io初始编号</param>
        /// <returns></returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_BusCmd_GetDriveIO", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_BusCmd_GetDriveIO(IntPtr handle, UInt32 axis,ref UInt32 IoStart);
        ...
        /// <returns></returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_BusCmd_SetNodeIo", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_BusCmd_SetNodeIo(IntPtr handle, UInt32 slot, UInt32 node, UInt32 IoStart);
        ...
        /// <param name="IoStart">io起始编号</param>
        /// <returns></returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_BusCmd_GetNodeIo", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_BusCmd_GetNodeIo(IntPtr handle, UInt32 slot, UInt32 node, ref UInt32 IoStart);
        ...
        /// <returns></returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_DisableGroup", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_DisableGroup(IntPtr handle, UInt32 axisNumber, UInt32[] axisList);
        ...
        /// <returns></returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_SetWdog", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_SetWdog(IntPtr handle, bool b);
        ...
        /// <param name="b">是否使能</param>
        /// <returns></returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_GetWdog", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_GetWdog(IntPtr handle,ref bool b);
        ...
        /// <returns></returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_MoveAddax", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_MoveAddax(IntPtr handle, int baseAxis, uint iaxisNumber, int[] iaddaxisList);
        ...
        /// <param name="imode">指定前面参数的意义  0 当前点，中间点，终点三点定圆弧，距离参数1为终点绝对位置，距离参数2为中间点绝对位置。1 走最小的圆弧，距离参数1为终点距离，距离参数2为圆心的绝对位置。2 当前点，中间点，终点三点定圆，距离参数1为终点绝对位置，距离参数2为中间点绝对位置。3 先走最小的圆弧，再继续走完整圆，距离参数1为终点绝对位置，距离参数2为圆心的绝对位置。</param>
        /// <param name="fcenter4">第4个轴运动绝对位置</param>
        /// <param name="fcenter5">第5个轴运动绝对位置</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_MSphericalAbs", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_MSphericalAbs(IntPtr handle, int imaxaxises, int[] piAxislist, float fend1, float fend2, float fend3, float fcenter1, float fcenter2, float fcenter3, int imode, float fcenter4, float fcenter5);
        ...
        /// <param name="fcenter2">第2个轴运动距离参数2	绝对位置</param>
        /// <param name="fcenter3"> 第3个轴运动距离参数2 绝对位置</param>
        /// <param name="imode">指定前面参数的意义:0 当前点，中间点，终点三点定圆弧，距离参数1为终点绝对位置，距离参数2为中间点绝对位置。 1 走最小的圆弧，距离参数1为终点绝对位置，距离参数2为圆心的绝对位置。2 当前点，中间点，终点三点定圆，距离参数1为终点绝对位置，距离参数2为中间点绝对位置。3 先走最小的圆弧，再继续走完整圆，距离参数1为终点绝对位置，距离参数2为圆心的绝对位置。</param>
        /// <param name="fcenter4">第4个轴运动距离参数 绝对位置</param>
        /// <param name="fcenter5">第5个轴运动距离参数 绝对位置</param>
        /// <returns></returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_MSphericalAbsSp", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_MSphericalAbsSp(IntPtr handle, int imaxaxises, int[] piAxislist, float fend1, float fend2, float fend3, float fcenter1, float fcenter2, float fcenter3, int imode, float fcenter4, float fcenter5);


        /// <summary>
        /// 开启一个任务运行zbaisc定义的函数，需要用到控制器/卡 本身的任务编号
        /// </summary>
        /// <param name="handle">句柄</param>
        /// <param name="taskNumber">控制器/卡的任务编号</param>
        /// <param name="BasicFunctionName">zbasic定义的函数名称可以带参数，例 test或test(1,2,3)或test(zbasic全局变量)</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_RunTask", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_RunTask(IntPtr handle, int taskNumber, string BasicFunctionName);
        ...
        /// <param name="taskNumber">控制器/卡的任务编号</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_StopTask", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_StopTask(IntPtr handle, int taskNumber);
        ...
        /// <param name="handle">句柄</param>
        /// <param name="taskNumber">控制器/卡的任务编号</param>
        /// <param name="status">状态返回值  0：任务停止   1:任务正在运行  3：任务暂停中</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_GetProcStatus", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_GetProcStatus(IntPtr handle, int taskNumber,ref int status);
        ...
        /// <param name="taskNumber">控制器/卡的任务编号</param>
        /// <returns></returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_ResumeTask", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_ResumeTask(IntPtr handle, int taskNumber);
        ...
        /// <param name="taskNumber">控制器/卡的任务编号</param>
        /// <returns></returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_PauseTask", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_PauseTask(IntPtr handle, int taskNumber);
        ...
        /// <param name="dist">补偿距离 units单位</param>
        /// <param name="speed">反向间隙速度</param>
        /// <param name="accel">反向间隙加速度</param>
        /// <returns></returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_Backlash", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
